pulse.ready(function() {
  var engine = new pulse.debug.Engine({debug : true});
  var cybertron = new pulse.Scene({name: 'cybertron'});

  var world = new pulse.debug.Layer({name: 'layer', x : 320, y : 240});
  world.zindex = 2;
  cybertron.addLayer(world);

  var bg = new pulse.debug.Layer({name: 'bg', x : 320, y : 240});
  bg.zindex = 1;
  ...
  var greenTexture = new pulse.Texture({filename:'../img/green_square.png'});
  var redTexture = new pulse.Texture({filename:'../img/red_square.png'});
  var ballTexture = new pulse.Texture({filename:'../pong/ball.png'});
