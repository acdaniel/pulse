...
pulse.debug.DebugCounter = PClass.extend(
/** @lends pulse.debug.DebugCounter.prototype */
{
  /** @constructs */
  init : function(params) {
    params = pulse.util.checkParams(params, {
      name : "Counter" + pulse.debug.DebugCounter.counterIdx++
    });
...
pulse.debug.DebugCounter.counterIdx = 0;