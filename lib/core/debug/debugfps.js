...
pulse.debug.DebugFPS = pulse.debug.DebugTimer.extend(
/** @lends pulse.debug.DebugFPS.prototype */
{
  /** @constructs */
  ...
  mark : function () {
    ...
    // running average 
    // var cfps = Math.round(1000 / this.marks[this.marks.length - 1]);
    // var pfps1 = this.fpsMarks[this.fpsMarks.length - 1] || 0;
    // var pfps2 = this.fpsMarks[this.fpsMarks.length - 2] || 0;
    // var pfps3 = this.fpsMarks[this.fpsMarks.length - 3] || 0;
    // var pfps4 = this.fpsMarks[this.fpsMarks.length - 4] || 0;
    // var pfps5 = this.fpsMarks[this.fpsMarks.length - 5] || 0;
